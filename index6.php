	...
	<body>
        ...
        <script>
            ...
            DG.then(function () {
              ...
              DG.marker([55.7433, 49.1350]).addTo(map).bindPopup('Время работы: в будни с 9:00 до 20:00 ');
              DG.marker([55.7954, 49.1713]).addTo(map).bindPopup('Время работы: в будни с 9:00 до 20:00 ');
              DG.marker([55.8591, 49.0040]).addTo(map).bindPopup('Время работы: в будни с 9:00 до 20:00 ');
              DG.marker([55.8288, 49.0807]).addTo(map).bindPopup('Время работы: в будни с 9:00 до 20:00 ');
              DG.marker([55.8253, 49.1952]).addTo(map).bindPopup('Время работы: в будни с 9:00 до 20:00 ');
